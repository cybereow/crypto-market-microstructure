...
def create_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Use mathematically safe RSI calculation to avoid inf values
    data['RSI_14'] = 100 * ema_up / (ema_up + ema_down + 1e-9)
    ...
    data['RSI_70'] = 100 * ema_up_w / (ema_up_w + ema_down_w + 1e-9)
    data['RSI_70'] = data['RSI_70'].fillna(50)
